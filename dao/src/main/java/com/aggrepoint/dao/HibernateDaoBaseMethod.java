 ...
 * 
 */
public class HibernateDaoBaseMethod<T> implements HibernateDaoMethod<T> {
	Class<T> clz;
	...
	static Object[][] methods = {
			...
			{ 29, "findSQL", new Class[] { String.class, Object[].class } }};
	...
	public Object invoke(Object proxy, Method method, Object[] args) {
		...
		case 28:
			...
			return null;
		case 29:
			return findSQL((String) args[0], (Object[]) args[1]);
		}
