...
public class TimeSpan
{
	...
	public long getDays()
	{
		...
		// else
		// {
		// day = (d1.getTime() - d2.getTime() - getTotalMinutes() * (24 * 60 * 60 * 1000)) / (24 * 60 * 60 * 1000);
		// }
		// return day;
		return getTotalDays();
	}
	...
	{
		TimeSpan ts1 = new TimeSpan(Converts.StrToDate("2013-02-02 16:21:41"), Converts.StrToDate("2013-01-02 15:00:00"));
