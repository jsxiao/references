...
public class RdImageEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		int num = 4;
		WordGenerator wgen = new RandomWordGenerator("0123456789");//new RandomWordGenerator("abcdefghijklmnopqrstuvwxyz123456789");
		...
		TextPaster textPaster = new RandomTextPaster(new Integer(num), new Integer(num), cgen, Boolean.valueOf(true));
