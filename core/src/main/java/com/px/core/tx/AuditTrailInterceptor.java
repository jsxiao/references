...
public class AuditTrailInterceptor implements Interceptor, InitializingBean{
	...
	private com.px.core.tx.annotation.IdGenerator idGen = null;
	
	private String getId() {
		return getIdGen().getUUID();
	}
	
	public com.px.core.tx.annotation.IdGenerator getIdGen(){
		return this.idGen;
	}
	
	public void setIdGen(com.px.core.tx.annotation.IdGenerator idGen){
		this.idGen = idGen;
	}
